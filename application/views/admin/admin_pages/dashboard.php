				...
				<div class="widget span3 red" onTablet="span6" onDesktop="span3">
					...
					<div class="content">
						...
						<div class="browserStat big">
							<img src="<?php echo base_url();?>asset/admin_asset/img/browser-chrome-big.png" alt="Chrome">
							<span>34%</span>
						</div>
						<div class="browserStat big">
							<img src="<?php echo base_url();?>asset/admin_asset/img/browser-firefox-big.png" alt="Firefox">
							<span>34%</span>
						</div>
						<div class="browserStat">
							<img src="<?php echo base_url();?>asset/admin_asset/img/browser-ie.png" alt="Internet Explorer">
							<span>34%</span>
						</div>
						<div class="browserStat">
							<img src="<?php echo base_url();?>asset/admin_asset/img/browser-safari.png" alt="Safari">
							<span>34%</span>
						</div>
						<div class="browserStat">
							<img src="<?php echo base_url();?>asset/admin_asset/img/browser-opera.png" alt="Opera">
							<span>34%</span>
						</div>	
				...
				<div class="box black span4" onTablet="span6" onDesktop="span4">
					...
					<div class="box-content">
						<ul class="dashboard-list metro">
							<li class="green">
								<a href="#">
									<img class="avatar" alt="Lucas" src="<?php echo base_url();?>asset/admin_asset/img/avatar.jpg">
								</a>
							...
							<li class="yellow">
								<a href="#">
									<img class="avatar" alt="Bill" src="<?php echo base_url();?>asset/admin_asset/img/avatar9.jpg">
								</a>
							...
							<li class="red">
								<a href="#">
									<img class="avatar" alt="Jane" src="<?php echo base_url();?>asset/admin_asset/img/avatar5.jpg">
								</a>
							...
							<li class="blue">
								<a href="#">
									<img class="avatar" alt="Kate" src="<?php echo base_url();?>asset/admin_asset/img/avatar6.jpg">
								</a>
