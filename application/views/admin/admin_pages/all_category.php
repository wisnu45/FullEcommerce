						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
                            <?php foreach($categories as $category){?>
								...
								<td class="center"><?php echo $category->category_short_desc?></td>
								<td class="center">
									<?php
								...
								<td class="center">
									...
									<?php }elseif($category->category_status == 2 || $category->category_status == 3){?>
										<a class="btn btn-danger" href="<?php echo base_url("change-category-status/$category->category_id/1");?>" title="Update Status">
										<i class="halflings-icon white thumbs-down"></i>                                            
										</a>
									<?php } ?>
									
									<a class="btn btn-info" href="<?php echo base_url("edit-category/$category->category_id");?>" title="Edit">
										<i class="halflings-icon white edit"></i>                                            
									</a>
									<?php if($category->category_status != 3){?>
										<a class="btn btn-danger" href="<?php echo base_url("change-category-status/$category->category_id/3");?>" title="Delete">
