...
<body>
				...
				<div class="row">
					...
					<div class="col-md-8 clearfix">
						<div class="shop-menu clearfix pull-right">
							<ul class="nav navbar-nav">
								<li><a href="<?php base_url();?>welcome/accounts"><i class="fa fa-user"></i> Account</a></li>
								...
								<?php 
									...
									if($customer_id){?>
									<li><a href="<?php echo base_url('logout');?>"><i class="fa fa-lock"></i> Logout - (<?php echo $this->session->userdata('customer_name');?>)</a></li>
								<?php }else{?>
	...
	<section>
		<div class="container">
			<div class="row">
			<?php if($category_tab != null){?>
				<div class="col-sm-3">
					<div class="left-sidebar">
						<h2>Category</h2>
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							<?php
								$categories = $this->admin_model->get_all_published_categories();
